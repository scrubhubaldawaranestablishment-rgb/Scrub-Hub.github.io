...
import VendorServiceRequestsPanel from '@/components/vendor/VendorServiceRequestsPanel';
...
import { filterServiceRequestsForVendor } from '@/lib/serviceRequestUtils';
...
export default function VendorPortal() {
  ...
  const load = async (u, selectedVendor) => {
    ...
    if (internal) {
      ...
      setVendor(v);
      if (v?.id) {
        const [d, wos, tix, allRequests] = await Promise.all([
        ...
        setWorkOrders(wos);
        setTickets(tix);
        setServiceRequests(filterServiceRequestsForVendor(allRequests, v));
      }
    } else {
  ...
  return (
    <div className="space-y-5">
          ...
          {!vendor ? (
            <div className="glass-card p-6">
              <div className="max-w-md mx-auto text-center mb-6">
                ...
                <h3 className="text-lg font-bold text-white mb-2">{t('Start Your Vendor Application')}</h3>
            ...
            <div className="space-y-5">
              <VendorServiceRequestsPanel requests={serviceRequests} vendor={vendor} />
      ...
      {view === 'onboarding' && (
        <div className="glass-card p-6" dir={isRTL ? 'rtl' : 'ltr'}>
