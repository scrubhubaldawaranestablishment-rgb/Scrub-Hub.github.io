  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={toggleLang}
          className="absolute top-5 flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium transition-all hover:opacity-90"
          style={{
